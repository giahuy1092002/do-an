...
function Temp() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const res = await axios({
                method: "get",
                url: `http://localhost:3001/device/getDataEquipById/v1`,
    ...
    return (
        <div style={{ marginTop: '20px', marginLeft: '10%' }}>
            ...
            <Modal
                title="Tải dữ liệu tử cảm biến ánh sáng"
                open={isModalOpen}
            ...
            <div style={{ width: '80%', marginBottom: '30px' }}>
                <h2 > <AreaChartOutlined /> Biểu đồ dữ liệu cảm biến nhiệt độ</h2>
