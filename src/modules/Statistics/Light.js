    ...
    useEffect(() => {
        const fetchData = async () => {
            const res = await axios({
                method: "get",
                url: `http://localhost:3001/device/getDataEquipById/v4`,
        ...
        datasets: [
            {
                ...
                borderColor: 'rgb(210, 219, 33)',
                backgroundColor: 'rgba(210, 219, 33, 0.5)',
            },
        ],
    };
    const columns = [
    ...
    return (
        <div style={{ marginTop: '20px', marginLeft: '10%' }}>
            ...
            <div style={{ width: '80%', marginBottom: '30px' }}>
                <h2 > <AreaChartOutlined /> Biểu đồ dữ liệu cảm biến ánh sáng</h2>
